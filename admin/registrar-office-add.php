...
?>
        ...
        <body>
            ...
            <div class="container mt-5">
                <a href="registrar_office.php" class="btn btn-dark">Go Back</a>

                <form method="post" class="shadow p-3 mt-5 form-w" action="req/registrar_office-add.php">
                    <h3>Add New Register Office User</h3>
                    <hr>
