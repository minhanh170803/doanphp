...
.activities .swiper-slide figcaption {
    font-size: 1rem;
    color: #0d6efd; /* Set the color for the caption */
    font-weight: bold;
}
    </style>
</head>
<body>
    ...
    <div class="container">
        <img src="img/banner-hero-main.jpg" alt="Hero Image" class="img-fluid mb-4" style="border-radius: 15px; max-height: 400px; object-fit: cover;">
    ...
    <footer class="footer">
        <div class="container">
            ...
            <p class="text-center mt-3" style="color: white;">&copy; <?= $setting['current_year'] ?> <?= $setting['school_name'] ?>. All rights reserved.</p>
        </div>
    </footer>
